...
public class JRedisUtil {
    ...
    private static JRedisUtil instance;
...
//===========================================================
    ...
    public static void main(String[] args) {
        ...
        String werwe = JRedisUtil.getInstance().strings().set("werwe", JSON.toJSONString(map));
        System.out.println(werwe);
        String s = JRedisUtil.getInstance().strings().get("werwe");
